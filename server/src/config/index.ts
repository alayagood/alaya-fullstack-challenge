...
export const CLOUDINARY_CLOUD_NAME = pe.CLOUDINARY_CLOUD_NAME
export const CLOUDINARY_API_KEY = pe.CLOUDINARY_API_KEY
export const CLOUDINARY_API_SECRET = pe.CLOUDINARY_API_SECRET
